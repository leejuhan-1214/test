  ...
  return input.map(raw=>{
    ...
    return {
      ...
      moves:moves.map(move=>({
        ...
        contact:!!move.contact,alwaysHit:!!move.alwaysHit,highCrit:!!move.highCrit,description:String(move.description||"").slice(0,300),effect:String(move.effect||"").slice(0,40),heal:Number(move.heal)||0,
        inflict:String(move.inflict||"").slice(0,30),selfStages:move.selfStages||null,targetStages:move.targetStages||null,secondary:move.secondary||null,recoil:Number(move.recoil)||0,drain:Number(move.drain)||0
      }))
    };
  });
}
